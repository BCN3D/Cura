            ...
            Repeater
            {
                ...
                delegate: Rectangle
                {
                    ...
                    Rectangle //Input field for pre-heat temperature.
                    {
                        ...
                        {
                            if(extruderTemperatureProvider.properties.maximum_value != "None" && extruderTemperatureProvider.properties.maximum_value <  Math.round(preheatExtruderTemperatureInput.text))
                            {
                                return true;
                            } else
                            {
                    ...
                    Button //The pre-heat button.
                    {
                        ...
                        enabled:
                        {
                            ...
                            if (extruderTemperatureProvider.properties.minimum_value != "None" && Math.round(preheatExtruderTemperatureInput.text) < Math.round(extruderTemperatureProvider.properties.minimum_value))
                            {
                                return false; //Target temperature too low.
                            }
                            if (extruderTemperatureProvider.properties.maximum_value != "None" && Math.round(preheatExtruderTemperatureInput.text) > Math.round(extruderTemperatureProvider.properties.maximum_value))
                            {
                                return false; //Target temperature too high.
                            }
                            if (Math.round(preheatExtruderTemperatureInput.text) == 0)
                            {
